...
python -m favie_data_schema.favie.tools.avro_to_pydantic --avsc="avsc/interface/media/output_code/favie_image_crawl_response.avsc" --output-file="favie_data_schema/favie/data/interface/media/favie_image_crawl_response.py"
echo "转化合并后的代码结束"
