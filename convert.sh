...
python -m favie_data_schema.favie.tools.combine_schemas_with_unique_define --source-directory="avsc/interface/product/source_code" --output-file="avsc/interface/product/output_code/favie_product_categories_predict_response.avsc" --main-schema="favie.data.interface.product.FavieCategoriesPredictResponse"
...
python -m favie_data_schema.favie.tools.avro_to_pydantic --avsc-dir="avsc/interface/product/output_code/" --output-file="favie_data_schema/favie/data/interface/product/favie_product.py"
