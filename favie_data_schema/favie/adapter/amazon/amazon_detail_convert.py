...
class AmazonDetailConvert():
    ...
    def convert_to_favie_product(amazon_message: CrawlerKafkaMessage) -> FavieProduct:
        ...
        favie_product.price = AmazonDetailConvert.get_price(rainforest_product_detail)
        favie_product.rrp = AmazonDetailConvert.get_rrp(rainforest_product_detail)
        favie_product.images = AmazonDetailConvert.get_images(rainforest_product_detail)
        favie_product.f_images = None
        favie_product.videos = AmazonDetailConvert.get_videos(rainforest_product_detail)
        favie_product.categories = AmazonDetailConvert.get_categories(rainforest_product_detail)
        favie_product.f_categories = None
        favie_product.brand = AmazonDetailConvert.get_brand(rainforest_product_detail)
        favie_product.f_brand = None
        favie_product.feature_bullets = rainforest_product_detail.product.feature_bullets        
        favie_product.attributes = AmazonDetailConvert.get_attributes(rainforest_product_detail)
        favie_product.specifications = AmazonDetailConvert.get_specifications(rainforest_product_detail)
        favie_product.standard_attributes = AmazonDetailConvert.get_standard_attributes(rainforest_product_detail)
        favie_product.offers = None
        favie_product.seller = AmazonDetailConvert.get_seller(rainforest_product_detail)
        ...
        favie_product.deal = AmazonDetailConvert.get_deal(rainforest_product_detail)
        ...
        favie_product.promotion = AmazonDetailConvert.get_promotion(rainforest_product_detail)
