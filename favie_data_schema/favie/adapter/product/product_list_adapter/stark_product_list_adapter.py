...
from favie_data_schema.favie.data.crawl_data.crawler.stark_product_list import Price as AmazonPrice
...
class StarkProductListAdapter(FavieProductDetailAdapter):
    ...
    def get_review_summary(crawl_result: StarkProductList) -> ReviewSummary:
        return ReviewSummary(rating=crawl_result.rating, ratings_total=crawl_result.ratings_total)
